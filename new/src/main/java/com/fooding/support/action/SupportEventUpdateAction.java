...
public class SupportEventUpdateAction implements Action {
...
//		session.setAttribute("id", "admin"); // 이 부분만 삭제하면 됨
		...
		SupportDTO dto = dao.supportEventContent(table_id);
		...
		// 페이지 이동
		forward.setPath("./fooding/khr/support/eventUpdateForm.jsp");
