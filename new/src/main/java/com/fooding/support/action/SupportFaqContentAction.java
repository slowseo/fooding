...
public class SupportFaqContentAction implements Action {

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// 출력문
		System.out.println("\t M : SupportFaqContentAction_execute() 호출 ");
...
//		session.setAttribute("id", "admin"); // 이 부분만 삭제하면 됨
		...
		dto = dao.supportFaqContent(table_id);
		...
		// 페이지 이동
		forward.setPath("./fooding/khr/support/faqContent.jsp");
