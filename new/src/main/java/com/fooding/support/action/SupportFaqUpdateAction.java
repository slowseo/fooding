...
public class SupportFaqUpdateAction implements Action {
...
//		session.setAttribute("id", "admin"); // 이 부분만 삭제하면 됨
		...
		SupportDTO dto = dao.supportFaqContent(table_id);
		...
		// 페이지 이동
		forward.setPath("./fooding/khr/support/faqUpdateForm.jsp");
