...
public class FtFrontMainController extends HttpServlet{
	...
	protected void doProcess(HttpServletRequest request,
		...
		if(command.equals("/FtMainAction.man")) {
			System.out.println(" C : /FtMainAction.man 매핑" );
			System.out.println(" C : 패턴2 - DB처리O, 페이지 이동");
			
			action = new FtMainAction();
			try {
