  ...
  <a href="./Support.sup" class="list-group-item list-group-item-action">고객센터</a>
	...
	<div class="card">
	  <div class="card-header">
   		 	주문번호 : ${requestScope.dto.purchaseid }<br>
  	  </div>
  	  </div>
		<div class="div1">
			<h1>Review Update</h1>
			...
			<form action="./ProfileReviewUpdatePro.pro?pageNum=${requestScope.pageNum }&search=${param.search }" method="post" enctype="multipart/form-data">
			...
			<div class="div3">
  				<div class="row justify-content-center">
    				...
    				<div class="col-sm-9">
      					<input type="text" class="form-control" name="nickname" id="nickname" value="${dto.nickname }" required>
    				</div>
  				</div>
  				<div class="row justify-content-center">
			...
			<div class="form-floating">
  				<textarea class="form-control" placeholder="리뷰를 입력해주세요" id="textarea" name="content" required>${dto.content }</textarea>
