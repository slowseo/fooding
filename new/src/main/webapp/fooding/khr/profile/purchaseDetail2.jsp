  ...
  <a href="./Support.sup" class="list-group-item list-group-item-action">고객센터</a>
	...
	<div class="card">
	  <div class="card-header">
			...
			주문일 : ${requestScope.list[0].orderdate }
  	  </div>
  	  </div>
		<div class="div1">
			<h1>Order Details</h1>
			...
			<input type="button" class="btn btn-secondary btn-sm" value="이전 페이지로" onclick=" location.href='./OrderDetails.pay?pageNum=${requestScope.pageNum}'; ">
			</form>
			</c:if>
