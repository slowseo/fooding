...
<section class="p-3 mb-2 bg-light text-dark">
	<br>
	<h1>Foodtruck Update</h1>
	<br>
	<form action="./AdminFoodtruckUpdatePro.adm?pageNum=${requestScope.pageNum }" method="post" enctype="multipart/form-data">
	<input type="hidden" name="foodtruck_id" value="${requestScope.dto.foodtruck_id }">
	<div class="row justify-content-center">
    	<label for="nickname" class="col-sm-2 col-form-label"><span>푸드트럭명</span></label>
    		<div class="col-sm-9">
      		<input type="text" class="form-control" name="foodtruck_name" id="foodtruck_name" value="${requestScope.dto.foodtruck_name }" required>
    	</div>
  	</div>
	<div class="form-floating">
  		<textarea class="form-control" placeholder="푸드트럭 정보를 입력해주세요" id="textarea" name="info" required>${requestScope.dto.info }</textarea>
