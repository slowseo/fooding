  ...
  <a class="list-group-item list-group-item-action disabled" aria-disabled="true"><b>1:1 문의 : 1234-5678</b></a>
	...
	<section class="p-3 mb-2 bg-light text-dark">
		...
		<div class="div1">
			...
			<br>
			<div class="div2">
			<form action="./SupportEventUpdatePro.sup?table_id=${requestScope.table_id }&pageNum=${requestScope.pageNum}" method="post">
			<div class="div3">
			...
			<div class="form-floating">
  				<textarea class="form-control" placeholder="FAQ 본문을 입력해주세요" id="textarea" name="content" required>${dto.content }</textarea>
  				<label for="textarea">이벤트 본문</label>
			</div>
  			<div class="col-auto mx-auto">
  				<input type="hidden" name="class" value="이벤트">
